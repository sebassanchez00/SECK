...
namespace CapaDatos
{
    public class DResultadoFinal
    {
        ...
        public DResultadoFinal(string idresultado, string idreporte, int cantidadpreguntas, int respuestasfallidas, int preguntasrespondidas, int respuestascorrectas,string cedula)
        {
        ...
        public string Insertar(DResultadoFinal resultadofinal)
        {
            ...
            try
            {
                ...
                ParIdReporte.ParameterName = "@IDRESULTADO";
