...
namespace CapaNegocio
{
    ...
    {
        /// <summary>
        /// Inserta registro en tabla EVALUACION_CONSTRUIDA
        /// </summary>
        ...
        /// <param name="p26"></param>
        /// <param name="p27"></param>
        /// <param name="p28"></param>
        /// <param name="p29"></param>
        ...
        /// <summary>
        /// Consulta tabla EVALUACION_CONSTRUIDA por ID 
        /// </summary>
        /// <param name="ID"></param>
        /// <returns></returns>
