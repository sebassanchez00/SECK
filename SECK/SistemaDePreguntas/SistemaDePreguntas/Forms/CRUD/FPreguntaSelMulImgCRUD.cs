...
{
    public partial class FPreguntaSelMulImgCRUD : Form
    {
        public FPreguntaSelMulImgCRUD()
        {
            InitializeComponent();
        ...
        private void btn_LeerCSV_Click(object sender, EventArgs e)
        {
            ...
            NLectorSeleccionMultipleImagen lector_obj = new NLectorSeleccionMultipleImagen(FilePath);
        ...
        {
            NPregunta.EliminarSelMulImg();
            MessageBox.Show("Todas las preguntas de tipo selección múltiple con imagen fueron eliminadas");
        }
    }
}
